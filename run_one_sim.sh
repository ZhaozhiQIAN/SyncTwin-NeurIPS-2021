...
nohup python -u pkpd_sim3_model_training.py --sim_id=${sim_id} --seed=100 --model_id=-prognostic-linear --reduced_fine_tune=True --tau=${tau} --lam_prognostic=1 --pretrain_Y=True --itr=10 --linear_decoder=True  > models/${sim_id}-prognostic_linear.txt &
nohup python -u pkpd_sim3_model_training.py --sim_id=${sim_id} --seed=100 --model_id=-prognostic-none --reduced_fine_tune=True --tau=${tau} --lam_prognostic=0 --pretrain_Y=False --itr=10 --linear_decoder=True  > models/${sim_id}-prognostic_none.txt &
