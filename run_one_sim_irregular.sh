...
python -u pkpd_sim3_model_training.py --regular=False --sim_id=${sim_id} --seed=100 --model_id=-prognostic-linear --reduced_fine_tune=True --tau=${tau} --lam_prognostic=1 --pretrain_Y=True --itr=3 --linear_decoder=True  > models/${sim_id}-prognostic_linear.txt
python -u pkpd_sim3_model_training.py --regular=False --sim_id=${sim_id} --seed=100 --model_id=-prognostic-none --reduced_fine_tune=True --tau=${tau} --lam_prognostic=0 --pretrain_Y=False --itr=3 --linear_decoder=True  > models/${sim_id}-prognostic_none.txt
