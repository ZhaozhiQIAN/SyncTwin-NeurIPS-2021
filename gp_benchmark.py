...
print('loading data')
n_units, n_treated, n_units_total, step, train_step, control_sample, noise, n_basis, n_cluster = io_utils.load_config(data_path, 'test')
...
for time_step in range(5):
    ...
    kernel = GPy.kern.RBF(input_dim=x_feat.shape[1], variance=np.var(Y_train), lengthscale=1.)
