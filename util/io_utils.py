...
def get_tensors(d1_train, d0_train, device):
    ...
    x_full, t_full, mask_full, batch_ind_full, y_full, y_control, y_mask_full = to_tensor(device, torch.float32, x_full, t_full, mask_full, batch_ind_full, y_full, y_control, y_mask_full)
